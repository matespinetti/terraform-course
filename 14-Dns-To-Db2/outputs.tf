...
output "private_app1_instances" {
  description = "Private app1 instance details"
  value = module.compute.private_app1_instances
}

output "private_app2_instances" {
  description = "Private app2 instance details"
  value = module.compute.private_app2_instances
}
