...
#RDS Outputs
output "web_app_db_info" {
    description = "Web App DB Info"
    value = {
        db_instance_id = module.web_app_db.db_instance_id
        db_instance_endpoint = module.web_app_db.db_instance_endpoint
        db_instance_port = module.web_app_db.db_instance_port
        db_instance_address = module.web_app_db.db_instance_address
    }
}